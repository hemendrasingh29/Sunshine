package com.example.zendynamix.sunshine.sync;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private static final int WEATHER_NOTIFICATION_ID = 3006;
...
Log.v(LOG_TAG,"*****"+url);
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if (cVVector.size() > 0) {
                ...
                // delete old data do that we dont build endless history of data
    ...
    private void notifyWeather() {
        ...
        Log.v(LOG_TAG,"last***************** sync"+lastSync);
...
// your application to the Home screen.
                TaskStackBuilder stackBuilder = create(getContext());
